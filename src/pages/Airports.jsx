    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-white to-sky-50">
      <header className="border-b border-slate-200/60 bg-white/80 backdrop-blur-md sticky top-0 z-10">
        <div className="max-w-6xl mx-auto px-6 py-4 flex items-center gap-3">
          ...
          <div>
            <h1 className="text-lg font-semibold tracking-tight text-slate-900">Flughäfen der Welt</h1>
            <p className="text-xs text-slate-500">Quelle: Global Airport Database</p>
          </div>
        </div>
      </header>
